...
/**
  ...
  * This 'enum' lets us use names like QWERTY, and FUNCTION in place of
  * the numbers 0 and 1.
  *
  */
...
const Key keymaps[][ROWS][COLS] PROGMEM = {
  ...
  (___,          Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   ...
   Key_PageDown, Key_Z, Key_X, Key_C, Key_V, Key_B, Key_PageUp,
  ...
  (___,      Key_F1,           Key_F2,      Key_F3,     Key_F4,        Key_F5,           XXX,
   ...
   ___,                        Key_F6,                 Key_F7,                   Key_F8,                   Key_LeftParen,   Key_RightParen,   Key_F11,
...
void setup() {
  ...
  Kaleidoscope.use(
    ...
    // We start with the rainbow wave effect lights up your keyboard with all the colors of a rainbow
